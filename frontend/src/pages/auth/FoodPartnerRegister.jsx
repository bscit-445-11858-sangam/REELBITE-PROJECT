...
const FoodPartnerRegister = () => {
  ...
  return (
    <div className="auth-page-wrapper auth-page-partner">
      <div className="auth-card partner-signup-card" role="region" aria-labelledby="partner-register-title">
        ...
        <nav className="auth-role-toggle partner-role-toggle" aria-label="Account type">
          <Link className="auth-toggle-btn" to="/user/register">User</Link>
          <Link className="auth-toggle-btn is-active" to="/food-partner/register">Food Partner</Link>
        </nav>
        <form className="auth-form partner-signup-form" onSubmit={handleSubmit} noValidate>
